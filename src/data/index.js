...
// 좌표는 섬 안(반경 ~60 이내)에 두어야 도달 가능하다. (섬 반경 HALF=70)
export const easterEggs = [
  { id: "egg-north", x: 3, z: -52, icon: "🌟", toast: "북쪽 끝까지 온 탐험가! 진짜 모험가구나. 숨은 장소를 찾았어요!" },
  { id: "egg-garden", x: -46, z: 44, icon: "🌸", toast: "숨은 꽃밭을 발견했어요! 여기서 잠시 쉬어가도 좋아요." },
  { id: "egg-cat", x: 46, z: -40, icon: "🐈", toast: "마을 고양이가 낮잠 자고 있어요... 야옹. 숨은 장소 발견!" },
];
