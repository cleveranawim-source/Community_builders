...
// 숨은 이스터에그: 거점에서 멀리 떨어진 섬 가장자리 외진 구석 3군데 (발견 반경 2.6)
// 거점 사이 빈 각도의 가장자리(반경 ~61)에 배치해 우연히 밟히지 않게 한다. (섬 반경 HALF=70)
export const easterEggs = [
  { id: "egg-north", x: 15, z: -59, icon: "🌟", name: "별똥별이 떨어진 자리", toast: "쉿— 별똥별이 떨어진 자리를 발견했어요. 조용히 소원을 빌어볼까요?" },
  { id: "egg-garden", x: -12, z: 60, icon: "🌸", name: "숨은 꽃밭", toast: "마을 남쪽 끝, 아무도 모르는 숨은 꽃밭을 발견했어요. 여기서 잠시 쉬어가도 좋아요." },
